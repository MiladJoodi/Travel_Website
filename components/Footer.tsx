      ...
      <div className="padding-container max-container flex w-full flex-col gap-14">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          ...
          <div className="flex flex-wrap gap-10 sm:justify-between md:flex-1">
            ...
            <div className="flex flex-col gap-5 regular-20">
              <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                {FOOTER_CONTACT_INFO.links.map((link) => (
                  <Link
                    href="/"
                    key={link.label}
                    className="flex items-center gap-4 md:flex-col lg:flex-row regular-20"
                  >
                    <p className="whitespace-nowrap regular-20">{link.label}:</p>
                    <p className="medium-16 whitespace-nowrap text-blue-70 regular-20">
                      {link.value}
                    </p>
                  </Link>
                ))}
